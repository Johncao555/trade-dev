...
public class SeckillActivityController {
    ...
    public TradeResultDTO<Order> processSeckill(long userId, long seckillActivityId) {
        ...
        try {
            ...
            Order order = seckillActivityService.processSeckill(userId, seckillActivityId);
            res.setData(order);
            res.setCode(200);
        } catch (Exception ex) {
            res.setCode(500);
